  ...
  return (
    <Section bgColor={bgColor}>
      <div className="tw-gap-8 tw-grid md:tw-grid-cols-5">
        <div className="tw-shadow-md md:tw-col-span-2 tw-bg-white tw-p-2 tw-rounded tw-flex tw-justify-center tw-items-center">
        ...
        <div className="md:tw-col-span-3 tw-text-slate-900 tw-text-lg tw-space-y-2">
          <div>
            ...
            of small credit unions through our Small Credit Union program.
          </div>

          <div>
            The Small Credit Union program is designed to facilitate growth and
